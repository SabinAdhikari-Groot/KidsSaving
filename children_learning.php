...
<head>
    ...
    <link rel="stylesheet" href="children_learning.css">
    <script>
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <p>Read the notes below before taking the quiz!</p>
            <div class="content">
                ...
                <ul>
                    ...
                    $sql = "SELECT id, title, content FROM finance_notes ORDER BY RAND() LIMIT 10";
